...
const [active, setActive] = useState({register:true, delete:false})
    ...
    return(
          <div className="relative w-full md:w-[50%] lg:w-[35%] uppercase font-bold text-sm text-center">
          ...
          {open && <div className="absolute bg-white flex flex-col w-full gap-5 p-2 pb-10 rounded">
