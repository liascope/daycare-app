...
export default function ReportedToday ({reportedToday}) {
   ...
   const today = new Date().toISOString().slice(0,10)
    return (<div className="flex-1 w-full transition-all duration-300 py-4 rounded-sm font-extrabold bg-linear-to-br from-yellow-50 via-yellow-300 to-yellow-200 px-5 text-white/90 uppercase tracking-wide">
